...
def generate_invoice(conn, order_id):
    ...
    # Insert invoice
    cursor.execute(
        "INSERT INTO invoices (invoice_number, invoice_date, due_date, total_amount, order_id, status) VALUES (?, ?, ?, ?, ?, 'pending')",
        (invoice_number, invoice_date, due_date, total_amount, order_id),
    )
    ...
    for item in order_items:
        ...
        cursor.execute(
            ...
            (invoice_number, item_id, quantity, price),
        )
